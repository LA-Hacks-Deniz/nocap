...
Implements equation 1 from §3.2.1:
    Attention(Q, K, V) = softmax(QK^T / sqrt(d_k)) V

This is a single-function implementation suitable for verification — no
multi-head wrapper, no projection layers, just the core scaled dot-product
operation as defined in the paper.
"""
